    ...
    <footer className="border-t border-base-700 bg-base-900/60 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-400">
            <li><a href="#" className="hover:text-accent">{t.footer.discord}</a></li>
            <li><a href="#" className="hover:text-accent">{t.footer.github}</a></li>
            <li><a href="#" className="hover:text-accent">{t.footer.contact}</a></li>
          </ul>
        </div>
      </div>
